    ...
    <?php
        ...
        <div id="modal1" class="modal">
            <div class="modal-content">
                ...
                <div class="row">
                    <form enctype="multipart/form-data" action="pages/DAO/galeriaDAO.php?case=1" method="post" class="col s12">
                        <div class="row">
        ...
        <script type="text/javascript">
            ...
            function mostrarCliente(contenedor) {
                ...
                // modal.getElementsByClassName('status-modal')[0].innerText = contenedor.getElementsByClassName('status-imagen')[0].innerText;
        ...
        <div id="modal2" class="modal">
            <div class="modal-content">
                ...
                <div class="row">
                    <form enctype="multipart/form-data" action="pages/DAO/galeriaDAO.php?case=2" method="post" class="col s12">
                        <div class="row">
                            <div class="col s12">
